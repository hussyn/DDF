...
public class ReadDataFromExcelSheet1 {
	...
	public static void main(String[] args) {
		...
		String testName="loginstart";
		//String sheetName = "demo";
		ReadDataFromExcelSheet1 excel = new ReadDataFromExcelSheet1();
		excel.getExcelDataBasedOnStartingPoint(excellocation, sheetName, testName);
