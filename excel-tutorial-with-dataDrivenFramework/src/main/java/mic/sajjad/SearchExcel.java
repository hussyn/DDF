...
public class SearchExcel {
    public static void main(String[] args) {
        try {
            // excel files
            FileInputStream excellFile = new FileInputStream(new File("E:\\TestData\\inputdata.xlsx"));
            //E:\TestData
            ...
            ArrayList<Row> rows = searchSheet("sajjad", sheet);
            System.out.println("filtered rows : \n"+rows);
            excellFile.close();

            System.out.println("Files were searched successfulyy ");
        } catch (Exception e) {
            e.printStackTrace();
        }
