 ...
 */
public class ReadDataFromExcelSheet3 {
	...
	public static void main(String[] args) throws IOException {
		...
		ReadDataFromExcelSheet3 excel = new ReadDataFromExcelSheet3();
		Object[][] data = excel.getExcelDataBasedOnStartingPoint(excellocation, sheetName, "Login Test");
